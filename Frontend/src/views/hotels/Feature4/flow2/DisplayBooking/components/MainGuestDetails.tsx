...
const MainGuestDetails = ({ guest }: { guest: MainGuestProps['guest'] }) => {
  return (
    <Card className="shadow rounded-2">
      <CardHeader className="border-bottom">
        <CardTitle as="h5" className="mb-0 d-flex align-items-center">
      ...
      <CardBody>
        <ListGroup variant="flush" className="list-group-borderless">
          <ListGroupItem className="d-flex justify-content-between align-items-center">
            <span className="h6 fw-light mb-0">Full Name</span>
            <span className="fs-5">{guest.salutation} {guest.first_name} {guest.last_name}</span>
          </ListGroupItem>
          <ListGroupItem className="d-flex justify-content-between align-items-center">
            <span className="h6 fw-light mb-0">Email</span>
            <span className="fs-5">{guest.email}</span>
          ...
          <ListGroupItem className="d-flex justify-content-between align-items-center">
            <span className="h6 fw-light mb-0">Mobile</span>
            <span className="fs-5">{guest.phone_number}</span>
          </ListGroupItem>
          <ListGroupItem className="d-flex justify-content-between align-items-center">
            <span className="h6 fw-light mb-0">Billing Address</span>
            <span className="fs-5">{guest.billing_address}</span>
          </ListGroupItem>
        </ListGroup>
      </CardBody>
    </Card>
