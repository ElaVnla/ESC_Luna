    ...
    const RoomCard = ({ features, images, name, price, amenities, schemes, count, hotelData, roomDataf4, hotelParams }: RoomCardProps ) => {
        ...
        // console.log(features, images, name, price, amenities, schemes, count, hotelData, roomDataf4, hotelParams)
        console.log(
            "RoomCard props:\n",
            JSON.stringify(
                { features, images, name, price, amenities, schemes, count, hotelData, roomDataf4, hotelParams },
                null,
                2 // <- pretty indent
            )
        );
